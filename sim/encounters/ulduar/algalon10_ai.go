...
func addAlgalon10(bossPrefix string) {
	core.AddPresetTarget(&core.PresetTarget{
		...
		Config: &proto.Target{
			...
			SwingSpeed:  1.00,
			// Estimated from logs for patch 3.4.1
			MinBaseDamage:    56000,
			SuppressDodge:    false,
			ParryHaste:       false,
			DualWield:        true,
...
func NewAlgalon10AI() core.AIFactory {
	return func() core.TargetAI {
		return &Algalon10AI{}
	}
}

func (ai *Algalon10AI) Initialize(target *core.Target, config *proto.Target) {
	ai.Target = target
...
func (ai *Algalon10AI) Reset(*core.Simulation) {
}

func (ai *Algalon10AI) registerQuantumStrikeSpell(target *core.Target) {
	...
	ai.QuantumStrike = target.RegisterSpell(core.SpellConfig{
		...
		// Patch 3.4.1: approx ~20% more damage
		DamageMultiplier: 1.2,
		CritMultiplier:   1,

		ApplyEffects: func(sim *core.Simulation, target *core.Unit, spell *core.Spell) {
			baseDamage := sim.Roll(15675, 17325)
			spell.CalcAndDealDamage(sim, target, baseDamage, spell.OutcomeAlwaysHit)
		},
	})
}

func (ai *Algalon10AI) registerPhasePunchSpell(target *core.Target) {
...
func (ai *Algalon10AI) registerBlackHoleExplosionSpell(target *core.Target) {
...
func (ai *Algalon10AI) registerCosmicSmashSpell(target *core.Target) {
...
func (ai *Algalon10AI) DoAction(sim *core.Simulation) {
